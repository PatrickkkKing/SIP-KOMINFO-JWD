...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/navhome.css') }}">
    ...
    <body style="background-color: rgb(231, 230, 230)">
        <div class="container" style="background-color: whitesmoke">
                <header class="d-flex justify-content-between align-items-center">
                    <div class="d-flex flex-column align-items-center">
                        <img width="50" height="50" src="{{ asset('img/logo-kominfo.png') }}" alt="Logo Kominfo">
                        <h3 style="color:#0000CA; margin-top: 2px; font-weight: bold;">KOMINFO</h3>
                    </div>
                    <div class="text-center">
                        <h1 style="font-weight: bold;">DIGITAL TALENT SCHOLARSHIP</h1>
                        <h4>Kementerian Komunikasi dan Informatika</h4>
                    </div>
                    <div class="d-flex flex-column align-items-center">
                        <img width="50" height="50" src="{{ asset('img/digitalent.png') }}" alt="Logo Digitalent">
                        <h3 style="margin-top: 2px; font-weight: bold;">digitalent</h3>
                    </div>
                </header>
        ...
        {{-- <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-center bg-gray-100">
            ...
            <img width="100" height="100" src="{{ asset('img/logo-kominfo.png') }}" alt="Logo Kominfo">
            <h1>Pelatihan VSGA KOMINFO</h1>
            @if (Route::has('login'))
